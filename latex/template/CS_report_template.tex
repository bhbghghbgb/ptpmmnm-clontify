...
\begin{comment}
    File \texttt{references.bib} đã chứa các tài liệu tham khảo. Khi biên dịch LaTeX, lệnh \texttt{\textbackslash bibliography{references}} sẽ tự động tạo danh sách tài liệu tham khảo dựa trên file này và \texttt{\textbackslash bibliographystyle{unsrt}} sẽ quy định cách hiển thị các mục. Lệnh \texttt{\textbackslash nocite{*}} đảm bảo tất cả các mục trong \texttt{references.bib} đều được hiển thị trong danh sách tài liệu tham khảo, ngay cả khi chúng không được cite trực tiếp trong báo cáo.
\end{comment}
    \nocite{*}
